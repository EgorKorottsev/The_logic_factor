 ...
 */
public class NormalQuestionsOpenHelper extends SQLiteOpenHelper {
    public static final String INT = " INTEGER, ";

    public NormalQuestionsOpenHelper(Context context) {
        super(context, "database_normal_questions", null, 1);
    }

    @Override
    public void onCreate(SQLiteDatabase database) {
        database.execSQL("create table table_normal_questions " +
    ...
    public void onUpgrade(SQLiteDatabase database, int oldVersion, int newVersion) {
        database.execSQL("DROP TABLE IF EXISTS table_normal_questions");
        onCreate(database);
    }
}
